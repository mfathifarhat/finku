...
<template>
    ...
    <div class="flex flex-1 flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div class="p-8 rounded-3xl bg-gradient-to-r from-indigo-950 via-slate-900 to-slate-950 border border-slate-800 text-white shadow-2xl relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-8 relative">
                ...
                <div class="flex-1 w-full">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-indigo-500/20 text-indigo-300 border border-indigo-500/35">
